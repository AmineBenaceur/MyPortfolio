  ...
  return (
    ...
    >
      <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
        <CardTitle
          style={{ color: "#fff", height: "176px", background: backgroundImg }}
        >
          {props.project.title}
        </CardTitle>
        ...
        <CardActions className="card-actions" border>
          {props.project.links.youtube && (
            <Button
              ...
              href={props.project.links.youtube}
              target="_blank"
            >
              Video
            </Button>
      ...
      <div>
        <Layout fixedDrawer>
          ...
          <Content
            style={{
              background:
                "url(https://images.pexels.com/photos/8892/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1) center / cover",
            }}
          >
